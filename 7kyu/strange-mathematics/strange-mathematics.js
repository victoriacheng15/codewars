...
e - 
p
- set up array based on the provided n 
- loop through each number and add 1 
- find the index of k
- return the index of k + 1 (look for the position in the array, not the index)
*/

function strangeMath(n, k) {
	const array = [...Array(n).keys()].map((num) => num + 1);
	return array.sort().indexOf(k) + 1;
}
